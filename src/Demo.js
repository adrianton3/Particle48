...
function Demo() {
	this.ps = [
		...
		new _P.ParticleSystem(  new _P.AreaEmitter(null, new _P.Point(300, 300), new _P.Point( 10,  10), new _P.Point(  -8, -8), new _P.Point(   8,  8), 5,  3, _P.HeavyParticle.factory), new _P.Point(0,0), new _P.Point(600, 600)),
		...
		new _P.ParticleSystem(  new _P.AreaEmitter(null, new _P.Point(200, 200), new _P.Point(200, 200), new _P.Point(  -8, -8), new _P.Point(   8,  8), 1,  8, _P.HSineParticle.factory), new _P.Point(0,0), new _P.Point(600, 600))];
